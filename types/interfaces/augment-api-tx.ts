...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    edgeNode: {
      ...
      bindNodeBatch: AugmentedSubmittable<(bindings: Vec<ITuple<[Bytes, Bytes, Bytes, Bytes]>> | ([Bytes | string | Uint8Array, Bytes | string | Uint8Array, Bytes | string | Uint8Array, Bytes | string | Uint8Array])[]) => SubmittableExtrinsic<ApiType>, [Vec<ITuple<[Bytes, Bytes, Bytes, Bytes]>>]>;
      ...
      registerNodeBatch: AugmentedSubmittable<(nodes: Vec<ITuple<[Bytes, Bytes]>> | ([Bytes | string | Uint8Array, Bytes | string | Uint8Array])[]) => SubmittableExtrinsic<ApiType>, [Vec<ITuple<[Bytes, Bytes]>>]>;
      setSuperior: AugmentedSubmittable<(newSuperior: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      ...
      unbindNodeBatch: AugmentedSubmittable<(bindings: Vec<ITuple<[Bytes, Bytes]>> | ([Bytes | string | Uint8Array, Bytes | string | Uint8Array])[]) => SubmittableExtrinsic<ApiType>, [Vec<ITuple<[Bytes, Bytes]>>]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    session: {
       ...
       * fixed.
       **/
      setKeys: AugmentedSubmittable<(keys: AroRuntimeSessionKeys | { babe?: any; grandpa?: any; imOnline?: any; authorityDiscovery?: any } | string | Uint8Array, proof: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AroRuntimeSessionKeys, Bytes]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    user: {
      ...
      bindEvmAccountBatch: AugmentedSubmittable<(items: Vec<ITuple<[Bytes, H160, U8aFixed]>> | ([Bytes | string | Uint8Array, H160 | string | Uint8Array, U8aFixed | string | Uint8Array])[]) => SubmittableExtrinsic<ApiType>, [Vec<ITuple<[Bytes, H160, U8aFixed]>>]>;
      createUser: AugmentedSubmittable<(userId: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes]>;
      createUserBatch: AugmentedSubmittable<(userIds: Vec<Bytes> | (Bytes | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Vec<Bytes>]>;
      setSuperior: AugmentedSubmittable<(newSuperior: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      /**
       * Generic tx
       **/
    ...
    utility: {
       ...
       * - O(1).
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: AroRuntimeOriginCaller | { system: any } | { Council: any } | { TechnicalCommittee: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AroRuntimeOriginCaller, Call]>;
      /**
       * Send a batch of dispatch calls.
